...
using static AssignmentMVC.Models.Coins;
...
namespace AssignmentMVC.Controllers
{
    public class CoinsController : Controller
    {
        ...
        public ActionResult Index(string searchString, string currentFilter, string MarketID)
        {
            ...
            var coins = db.Coins.Where(s => s.Status != Coins.CoinStatus.Delete);
        ...
        public ActionResult Create([Bind(Include = "Code,BaseAsset,QuoteAsset,LastPrice,Volumn24h,MarketId,Status")] Coins coin)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Code,BaseAsset,QuoteAsset,LastPrice,Volumn24h,MarketId,Status")] Coins coin)
        {
            if (ModelState.IsValid)
            {
